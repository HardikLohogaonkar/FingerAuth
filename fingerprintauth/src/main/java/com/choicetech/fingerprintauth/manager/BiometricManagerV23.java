...
import com.choicetech.fingerprintauth.dialog.BiometricDialogV23;
...
public class BiometricManagerV23 {
    ...
    protected Drawable imglogo;
    protected CancellationSignal mCancellationSignalV23 = new CancellationSignal();
    protected int titlecolor,subtitlecolor,descriptioncolor,btncolor;
    ...
    private void displayBiometricDialog(final BiometricCallback biometricCallback) {
        ...
        biometricDialogV23.setImgLogo(imglogo);
        biometricDialogV23.show();
        biometricDialogV23.setTitleTextColor(titlecolor);
        biometricDialogV23.setSubtitleTextColor(subtitlecolor);
        biometricDialogV23.setItemDescriptionTextColor(descriptioncolor);
        biometricDialogV23.setBtnCancelTextColor(btncolor);
        biometricDialogV23.setCancelable(false);
        biometricDialogV23.setOnKeyListener(new DialogInterface.OnKeyListener() {
            @Override
